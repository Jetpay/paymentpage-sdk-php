...
namespace jetpay\tests;

use jetpay\PaymentPage;
use jetpay\SignatureHandler;
use jetpay\Payment;
...
class PaymentPageTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetUrl()
    {
        ...
        self::assertEquals(
            'https://paymentpage.jetpay.kz/payment?project_id=100&interface_type=%7B%22id%22%3A23%7D'
